...
用法:
    ...
    ANTHROPIC_API_KEY=sk-... python -m scenarios.testdesign.run \\
        --requirement-doc path/to/需求文档.md \\
        --output scenarios/testdesign/output/testcases.json
...
from scenarios.testdesign.schemas.state import empty_state
from scenarios.testdesign.workflow import build_workflow
